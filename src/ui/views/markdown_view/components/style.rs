...
pub(crate) const STYLE: MarkdownStyle = MarkdownStyle {
    general: GeneralStyle {
        content_padding: 15.0,
        section_spacing: 4.0,
        item_spacing_small: 2.0,
        divider_height: 1.0,
    ...
    block: BlockMarginStyle {
        heading_h1: 24.0,
        heading_h2: 20.0,
        heading_default: 16.0,
        horizontal_rule: 24.0,
        code: 16.0,
        table: 16.0,
        quote: 16.0,
        image: 16.0,
