...
use crate::features::vector::font_content::FontContent;
use crate::parsers::{ParseError, PreviewParser};
use std::path::Path;

pub struct FontParser;

impl PreviewParser<crate::app::Message> for FontParser {
    ...
    fn parse(
        ...
        meta.push(format!(
            "File size: {}",
            crate::core::utils::human_size(file_size)
        ));
