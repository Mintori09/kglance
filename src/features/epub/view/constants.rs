...
pub const CHAPTER_TITLE_SIZE_LEVEL_ONE: f32 = 12.5;
pub const CHAPTER_TITLE_SIZE_OTHER: f32 = 11.5;
pub const SIDEBAR_RESIZE_STEP: f32 = spacing::XXL;
pub const MAX_INDENT: f32 = 64.0;
pub const CONTENT_SPACING: f32 = spacing::XL;
