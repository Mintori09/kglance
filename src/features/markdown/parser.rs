...
use crate::{
    log_debug, log_error,
    parsers::{ParseError, PreviewParser},
};

use super::types::{Block, Inline, ListItem, TableBlock, TableCell};
...
impl PreviewParser<crate::app::Message> for MarkdownParser {
...
mod tests {
    ...
    fn parses_basic_markdown() {
        ...
        assert_eq!(
            ...
            crate::core::ContentType::Markdown
        );
    }
